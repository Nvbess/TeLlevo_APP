...
@Component({
  selector: 'app-cond-editprofile',
  templateUrl: './cond-editprofile.page.html',
  styleUrls: ['./cond-editprofile.page.scss'],
})
export class CondEditprofilePage implements OnInit {
